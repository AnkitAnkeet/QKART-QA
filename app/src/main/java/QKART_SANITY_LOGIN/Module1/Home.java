...
public class Home {
    ...
    public Boolean isNoResultFound() {
        ...
        try {
            ...
            WebElement em = driver.findElement(By.xpath("//h4[text()=' No products found ']"));
            status = em.isDisplayed();
            return status;
        } catch (Exception e) {
            return status;
        }
    ...
    public Boolean addProductToCart(String productName) {
        try {
            ...
            List<WebElement> productTitleElements = driver.findElements(By.xpath("//p[@class='MuiTypography-root MuiTypography-body1 css-yg30e6']"));
             ...
             for(int i=0;i<addToCartButtonElements.size();i++){
                WebElement titleElement = productTitleElements.get(i);
