...
public class SearchResult {
    ...
    public String getTitleofResult() {
        ...
        WebElement childElement = parentElement.findElement(By.xpath(".//p[@class='MuiTypography-root MuiTypography-body1 css-yg30e6']"));
        titleOfSearchResult = childElement.getText();
    ...
    public Boolean openSizechart() {
        try {
            ...
            WebElement hyperLinkcontent = parentElement.findElement(By.xpath(".//button[text()='Size chart']"));
            hyperLinkcontent.click();
            Thread.sleep(2000);
            return true;
        } catch (Exception e) {
    ...
    public Boolean validateSizeChartContents(List<String> expectedTableHeaders, List<List<String>> expectedTableBody,
        ...
        try {
            ...
            for(int j=0; j<expectedTableHeaders.size();j++){
                String expectedTableHeaderText = expectedTableHeaders.get(j);
                int col = j + 1 ;
                String xpath = "//table/thead/tr/th[" + col + "]";
                WebElement headerElement = driver.findElement(By.xpath(xpath));
                String actualTableheaderText = headerElement.getText();
                if(!(actualTableheaderText.equals(expectedTableHeaderText))){
                    status = false;
                }
            ...
            for(int i=0;i<expectedTableBody.size();i++){
                ...
                for(int j=0; j<rowList.size();j++){
                   ...
                   int col = j+1;
                    ...
                    WebElement tablebodyElement = driver.findElement(By.xpath(xpath));
    ...
    public Boolean verifyExistenceofSizeDropdown(WebDriver driver) {
        ...
        try {
            // TODO: CRIO_TASK_MODULE_TEST_AUTOMATION - TEST CASE 04: MILESTONE 2
            // If the size dropdowne exists and is displayed return true, else return false
